...
CREATE TABLE `u_attachment` (
  ...
  `ORIGINALFILENAME` varchar(50) NOT NULL COMMENT '原始名称',
  `ACTUALFILENAME` varchar(50) NOT NULL COMMENT '实际名称',
  `FILESIZE` varchar(50) NOT NULL COMMENT '大小',
  `FILETYPE` varchar(50) NOT NULL COMMENT '类别',
  `CREATETIME` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`ATTID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
ALTER TABLE stu_demo_code ADD COLUMN `LEVEL` int(10) DEFAULT 1 COMMENT '等级';

ALTER TABLE u_attachment change COLUMN FILETYPE FILETYPE VARCHAR (200) DEFAULT NULL COMMENT '类别';
